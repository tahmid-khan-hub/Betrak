        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 md:items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            {WhyItMattersData.map((item) => (
              <div
                key={item.heading}
                className="flex flex-col items-center justify-center gap-3 rounded-2xl border border-white/10 bg-white/5 p-8 text-center transition-colors hover:border-indigo-500/40 hover:bg-white/10"
              >
