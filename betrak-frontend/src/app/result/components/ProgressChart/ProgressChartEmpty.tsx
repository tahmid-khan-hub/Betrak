...
const ProgressChartEmpty = () => (
    <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
        ...
        <div className="flex flex-col items-center justify-center py-8 gap-2">
            <p className="text-sm text-gray-400">Complete one more assessment to unlock your progress chart.</p>
            <p className="text-xs text-gray-600">Your trends across sessions will appear here.</p>
        </div>
    </div>
);
